...
class Baserow:
    ...
    def make_api_request(self, 
                     ...
                     timeout: int = 10, 
                     files: Optional[Dict[str, IO[bytes]]] = None) -> Any:
        """
        ...
        response = self.perform_request(method, url, combined_headers, data, timeout, files)
    ...
    def get_combined_headers(self, additional_headers: Optional[Dict[str, str]]) -> Dict[str, str]:
        """
    ...
    def perform_request(self, 
                        ...
                        data: Optional[Dict] = None, 
                        timeout: int = 10, 
                        files: Optional[Dict[str, Union[str, IO[bytes]]]] = None) -> requests.Response:
        """
        ...
        try:
            ...
            if files:
                ...
                response = self.session.request(method=method, url=url, headers=headers, json=data, timeout=timeout)
    ...
    def parse_response(self, response: requests.Response, method: str, url: str) -> Union[int, Dict[str, Any], str]:
        """
